            ...
            modelBuilder.Entity("Blog.Data.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreateDate = new DateTime(2019, 12, 11, 17, 11, 25, 393, DateTimeKind.Utc), Deleted = false, Description = "....", Name = "Aşk" },
                        new { Id = 2, CreateDate = new DateTime(2019, 12, 11, 17, 11, 25, 394, DateTimeKind.Utc), Deleted = false, Description = "!!!!", Name = "Meşk" }
                    );
                });
            ...
            modelBuilder.Entity("Blog.Data.Models.Nationality", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "tr", CreateDate = new DateTime(2019, 12, 11, 17, 11, 25, 394, DateTimeKind.Utc), Deleted = false, Name = "Türkiye" }
                    );
                });
            ...
            modelBuilder.Entity("Blog.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, BirthDate = new DateTime(1990, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), CreateDate = new DateTime(2019, 12, 11, 17, 11, 25, 395, DateTimeKind.Utc), Deleted = false, Email = "sedakrpe@gmail.com", Gender = 1, Name = "Seda", NationalityId = 1, Password = "11223344", Surname = "Korpe", Username = "seda" }
                    );
                });
